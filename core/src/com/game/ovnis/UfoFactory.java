...
public class UfoFactory {
    ...
    public UfoFactory(GameBoard board, Test1 test1) {
        this.board = board;
        this.test1 = test1;
    }
    ...
    private Ufo createUfoRight() {
        ...
        Ufo ufo = flyUfo(boardPos, board.getScreenPosOvni(boardPos), Side.LEFT, AssetsFactory.instance().getOvni());
    ...
    private Ufo createUfoLeft() {
        ...
        Ufo ufo = flyUfo(boardPos, board.getScreenPosOvni(boardPos), Side.RIGHT, AssetsFactory.instance().getOvni());
        metronome.subscribe(ufo);
        return ufo;
    }
